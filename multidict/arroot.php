...
<!--
Switched off at present because it requires ntlk which is not currently installed at multidict.net due to shortage of filespace
<?php
  ...
  if (empty($word)) {
    ...
    $root = shell_exec("python3 ".escapeshellarg($document_root/multidict/arroot.py.' '.$word));
