  ...
  function getEmbed($medembed) {
    ...
    //If $medembed is not recognised as any such url, then it is returned unchanged.
      $embedcodeArr = array(
          ...
          '|(.*)://(.*)\.mp4$|u'
                           => '<video controls="controls" style="width:480px" title="View video (.mp4 - may not work in all browsers and platforms)"> <source src="$1://$2.mp4" type="video/mp4"/>  <span style="color:red;font-size:90%">[No <video> element support - You need to update your browser]</span> </video>',
