...
<td id=mean$vocid class=meaning>
    ...
    <span id=rand$vocid class=rand draggable=true>TEST</span>
...
function shuffle(array) {
    ...
    return array;
        ...
        function randomize() {
//var sgudal = ['A','B','C','D','E'];
//var sgudalPrev = [...sgudal];
//var sgudalShuffle = shuffle(sgudal);
//alert(sgudalPrev.toString() + '\\n' + sgudalShuffle.toString());
//return;
           ...
           //Process each vocabulary element
            for (vocid of vocids) {
                ...
                spanEl.style.backgroundColor = 'teal';
                var vocidShuffle = randMap.get(vocid);
                spanEl.innerHTML = document.getElementById('inp'+vocidShuffle).value;
            }
        }
    </script>
</head>
